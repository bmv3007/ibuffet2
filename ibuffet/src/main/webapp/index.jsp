...
<%@page import="com.mycompany.ibuffet.dao.ProductDAOImpl"%>
<%@page import="com.mycompany.ibuffet.beans.Product"%>
<html>
<head>
					...
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
						<div class="row masonry" data-columns>
							...
							<jsp:useBean id="productList"
								class="com.mycompany.ibuffet.dao.ProductDAOImpl" scope="page"></jsp:useBean>
